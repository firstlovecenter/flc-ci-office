...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn('px-2 py-1.5 text-xs font-semibold tracking-wider uppercase text-muted-foreground', inset && 'pl-8', className)} {...props} />
))
