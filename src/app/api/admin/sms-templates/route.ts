    ...
    const defaultTemplates = [
        {
            ...
            template: 'FLC CI Office: Your password reset code is {{resetCode}}. Valid for {{expirationHours}} hours. Go to the reset page and enter this code.',
        ...
        },
        {
            ...
            template: 'FLC CI Office: Hello {{userName}}, your role has been updated to {{role}} for {{department}}.',
        ...
        },
        {
            ...
            template: 'FLC CI: {{userName}}, your {{type}} transaction of {{amount}} is now {{status}}.',
        ...
        },
        {
            ...
            template: 'FLC CI - {{departmentName}}: {{message}}',
        ...
        },
        {
            ...
            template: 'FLC CI: Hello {{userName}}, Week {{weekNumber}} has been locked. No further changes can be made to transactions for this week.',
        ...
        },
        {
            ...
            template: 'FLC CI: Hello {{userName}}, you have {{pendingCount}} transaction(s) pending your approval. {{dashboardLink}}',
